 ...
 ******************************************************************************/
 ...
 sakai.editor.editors.ckeditor.launch = function(targetId, config, w, h) {
     ...
     //Some defaults for audio recorder
         ...
         extraPlugins: (sakai.editor.enableResourceSearch ? 'resourcesearch,' : '')+'bt_table, a11ychecker,autogrow,emoji,autolink,codesnippet,mentions,justify,balloontoolbar,balloonpanel,bidi,templates,mathjax,preview,showblocks,find,removeformat,pastetools,pastefromword,image2,contentitem,wordcount,notification,autosave,sakaiopenlink,sakaidropdowntoolbar,sakaiformat,',
         mentions: [{
         ...
         toolbar_Basic:
         [
             ['Source', '-','A11ychecker', 'Bold', 'Italic', 'Underline', '-', 'Link', 'Unlink', '-', 'NumberedList','BulletedList', 'Blockquote']
         ],
         toolbar_Full:
         [
             ['Format' ],
             ...
             [ 'EmojiPanel', 'Mathjax', 'SpecialChar', 'CodeSnippet'],
             [ 'A11ychecker', 'ShowBlocks'],
             '/',
             ['Replace', 'Preview'], ['BidiLtr', 'BidiRtl'],['Source']
     ...
     (function() {
         ...
         // ckconfig.contentsCss.push (basePath+'atd-ckeditor/atd.css');
         ckconfig.codeSnippet_theme='github-gist';
